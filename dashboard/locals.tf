...
#    login_url="https://keycloak.toto.svc.cluster.local/realms/realm1/protocol/openid-connect/auth"
#    redeem_url="https://keycloak.toto.svc.cluster.local/realms/realm1/protocol/openid-connect/token"
#    profile_url="https://keycloak.toto.svc.cluster.local/realms/realm1/protocol/openid-connect/userinfo"
#    validate_url="https://keycloak.toto.svc.cluster.local/realms/realm1/protocol/openid-connect/userinfo"
#    ssl_insecure_skip_verify=true
#    cookie_secure="true"
#    # Upstream config
#    http_address="0.0.0.0:4180"
#    # upstreams="file:///dev/null"
#    upstreams="https://oauth-oauth2-proxy.toto.svc.cluster.local/oauth2/auth"
#    email_domains=["*"]
#    oidc_issuer_url="https://keycloak.toto.svc.cluster.local/realms/realm1"
#    cookie_domains = ["toto.svc.cluster.local, localhost"]
#    scope="openid"
#    whitelist_domains = ["*.toto.svc.cluster.local, *.localhost"]
#    redirect_url="https://oauth-oauth2-proxy.toto.svc.cluster.local/oauth2/callback"
...
extraArgs:
  ...
  provider-display-name: Oauth2 Login
  client-id: dashboard-kube
  client-secret: z4Ux09d1GrR5GVUMleJVSPwYkDFdiaxZ
  ...
  upstream: "https://dashboard-kong-proxy.${var.namespace}.svc.cluster.local:443"
...
htpasswdFile:
  ...
  existingSecret: ""
  entries:
    - "superadmin:$2y$05$2n1epcHHCKHWDDKEKxt5..ZHt4vaqMymjc/dvHWCgbHMlLoUc86g2"
